...
type EmployeeStats = { total: number; aktif: number; nonAktif: number; segera: number; expired: number }
export type KaryawanInitial = {
        ...
        <div className="flex flex-col items-center gap-3 rounded-lg border border-rose-200 bg-rose-50 px-4 py-8 text-center dark:border-rose-900 dark:bg-rose-950/30">
          ...
          <div className="space-y-1">
            ...
            <p className="max-w-[320px] text-xs text-muted-foreground">
              Terjadi kendala saat mengambil data trainee. Periksa koneksi lalu coba lagi.
            </p>
          </div>
          <button
            onClick={refresh}
